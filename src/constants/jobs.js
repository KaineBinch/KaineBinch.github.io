export const jobs = [
  {
    ...
    bulletDesc: [
      ...
      "Collaborated with staff members to improve and adapt systems continuously.",
  ...
  },
  {
    ...
    bulletDesc: [
      "Direct line manager for a team of staff members, proficient in managerial duties.",
      "Experienced in making decisions with direct impact on people's lives, adept at justifying actions logically.",
      "Conduct audits, observations, and performance management tasks including supervisions, appraisals, and meetings.",
      "Maintained awareness of CQC policies and legal obligations to uphold standards consistently.",
      "Managed safeguarding incidents, conducting thorough investigations and determining appropriate actions.",
      "Conducted comprehensive staff training and development sessions to enhance skills and knowledge within the team",
    ],
